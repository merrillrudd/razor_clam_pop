  ...
  tabsetPanel(
    ...
    tabPanel("Learn about risks",
             ...
             tabsetPanel(
               ...
               tabPanel("Harmful algal blooms", column(8,
                        h3("Harmful algal blooms (HABs)"),
                        h4("Razor clams eat microscopic algae that they filter from sea water using tiny hairs on their gills. Under some ocean conditions (warmer water temperatures, increased availability of nutrients and sunlight), certain species of algae which produce neurotoxins grow extremely quickly, resulting in a "harmful algal bloom". When razor clams eat these toxic algae it does not hurt them. However, if humans eat seafood that is contaminated with these algal toxins, it can cause illness or even death because the toxins damage our nervous system."),
                        h4("In order to protect human health, Washington State closes the razor clam fisheries when a harmful algal bloom occurs. During our study we heard from many Quinault clammers who had suffered from a loss of food, income, and cultural expression during the long harmful algal bloom of 2015. Unfortunately, there is new scientific evidence suggesting that these harmful algal blooms might happen more frequently in the future because of climate change. In the model, a harmful algal bloom affects the number of times that the razor clam fishery is closed."),
                        img(src="red_tide.png", align="center")
                        )),
               tabPanel("Storm surge", column(8,
                        h3("Storm surge"),
                        h4("Young razor clams that have recently settled on beaches can be displaced by large waves that move sand. These displaced clams are likely to be eaten by fish that feed in the surf, and so strong waves can reduce razor clam survival. During our study, we heard reports that strong storms and high surf have become more common in recent years.  Warming in the ocean and atmosphere may be changing the paths of storms across the Pacific, or allowing for more intense storms to develop. In any case, if high surf continues to become more common, the survival of young razor clams might be reduced. To explore the impact of this change, increasing wave heights and storm surges in the model causes pre-recruit survival to decline consistently through time."),
                        img(src="storm_surge.png", align="center")
                        )),
               tabPanel("Pollution", column(8,
                        h3("Pollution"),
                        h4("Razor clams can be hurt by a variety of man-made pollutants including oil and runoff from roads and parking lots. These pollutants can be chronic, meaning ongoing over time, or episodic, meaning they happen at specific moments but are not constant. During our study, we heard concerns about the potential for oil spills during ocean transportation, and increasing contamination from new development near beaches. Oil and other contaminants are toxic to marine life such as razor clams, and are likely to kill a portion of the population if they increase to dangerous levels. Ongoing monitoring confirms that razor clams are not presently contaminated, but if pollution increases in the future this may change. To explore this possibility, including increased pollution in the model will reduce both recruit and pre-recruit survival through time."),
